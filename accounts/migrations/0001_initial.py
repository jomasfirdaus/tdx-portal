    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Super Admin'), ('editor', 'Content Editor')], db_index=True, default='editor', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['ip_address', '-created_at'], name='accounts_lo_ip_addr_279dc1_idx')],
            },
        ),
    ]
